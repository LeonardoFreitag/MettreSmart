...
export const TextoRigth = styled.Text`
    font-size: 20px;
    font-weight: bold;
    color: #ff9800; 
    margin-bottom: 1px;
...
export const TextoLeft = styled.Text`
    font-size: 20px;
    font-weight: bold;
    color: #ff9800; 
    margin-bottom: 1px;
...
export const ListPayments = styled.FlatList.attrs({
    paddingHorizontal: 15,
    paddingVertical: 10
})`
    /* margin-top: 15px; */
...
export const TouchPayment = styled.TouchableOpacity`
    background-color: #333333;
    margin-bottom: 2px;
    padding: 7px;
    border-radius: 5px;
...
export const PaymentTextLeft = styled.Text`
    font-size: 15px;
    font-weight: bold;
    color: #b8860b; 
    margin-top: 5px;
...
export const PaymentTextRight = styled.Text`
    font-size: 15px;
    font-weight: bold;
    color: #b8860b; 
    margin-top: 5px;
